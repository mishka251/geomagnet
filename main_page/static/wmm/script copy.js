...
$(document).keypress(function(e) {
		...
		function calcGMF(){	
		   ...
		   reversGeocode(shir_, dolg_);
			var url = "wmm/calc.php?lat=" + shir_ + "&lng=" + dolg_ + "&data=" + data + "&alt=" + alt+ "&h="+h;
			//console.log(url);
			$.ajax({ url: url,
...
//
		function showCalcResults(request){
			var xmlDoc = jQuery.parseXML(request);
			if (xmlDoc) 
			{
				...
				if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./))      // If Internet Explorer
					{
						var lamda = xmlDoc.getElementsByTagName("lamda")[0].text;
						var teta = xmlDoc.getElementsByTagName("teta")[0].text;
						var N = xmlDoc.getElementsByTagName("N")[0].text;
						var U = xmlDoc.getElementsByTagName("U")[0].text;
						var Bx = xmlDoc.getElementsByTagName("Bx")[0].text;
						var By = xmlDoc.getElementsByTagName("By")[0].text;
						var Bz = xmlDoc.getElementsByTagName("Bz")[0].text;
						var B = xmlDoc.getElementsByTagName("B")[0].text;
						var D = xmlDoc.getElementsByTagName("D")[0].text;
						var I = xmlDoc.getElementsByTagName("I")[0].text;	
						var FI = xmlDoc.getElementsByTagName("FI")[0].text;	
						var LAMDA = xmlDoc.getElementsByTagName("LAMDA")[0].text;	
						var M = xmlDoc.getElementsByTagName("M")[0].text;						
					}
				else {
						var lamda = xmlDoc.getElementsByTagName("lamda")[0].firstChild.nodeValue;
						var teta = xmlDoc.getElementsByTagName("teta")[0].firstChild.nodeValue;
						var N = xmlDoc.getElementsByTagName("N")[0].firstChild.nodeValue;
						var U = xmlDoc.getElementsByTagName("U")[0].firstChild.nodeValue;
						var Bx = xmlDoc.getElementsByTagName("Bx")[0].firstChild.nodeValue;
						var By = xmlDoc.getElementsByTagName("By")[0].firstChild.nodeValue;
						var Bz = xmlDoc.getElementsByTagName("Bz")[0].firstChild.nodeValue;
						var B = xmlDoc.getElementsByTagName("B")[0].firstChild.nodeValue;
						var D = xmlDoc.getElementsByTagName("D")[0].firstChild.nodeValue;
						var I = xmlDoc.getElementsByTagName("I")[0].firstChild.nodeValue;	
						var FI = xmlDoc.getElementsByTagName("FI")[0].firstChild.nodeValue;	
						var LAMDA = xmlDoc.getElementsByTagName("LAMDA")[0].firstChild.nodeValue;	
						var M = xmlDoc.getElementsByTagName("M")[0].firstChild.nodeValue;	
						var X_ = xmlDoc.getElementsByTagName("X_")[0].firstChild.nodeValue;
						var Y_ = xmlDoc.getElementsByTagName("Y_")[0].firstChild.nodeValue;
						var Z_ = xmlDoc.getElementsByTagName("Z_")[0].firstChild.nodeValue;
					...
					document.getElementById('X_print').innerHTML = parseFloat(X_).toFixed(5);
					document.getElementById('Y_print').innerHTML = parseFloat(Y_).toFixed(5);
					document.getElementById('Z_print').innerHTML = parseFloat(Z_).toFixed(5);					
					document.getElementById('shir_geopole_print').innerHTML = parseFloat(FI).toFixed(1);
					document.getElementById('dolg_geopole_print').innerHTML = parseFloat(LAMDA).toFixed(1);
					...
					document.getElementById('Bx_print').innerHTML = parseFloat(Bx).toFixed(2);
					document.getElementById('By_print').innerHTML = parseFloat(By).toFixed(2);
					document.getElementById('Bz_print').innerHTML = parseFloat(Bz).toFixed(2);
					document.getElementById('B_print').innerHTML = parseFloat(B).toFixed(2);
					...
					//
					document.getElementById('shir_geopole').innerHTML = parseFloat(FI).toFixed(1);
					document.getElementById('dolg_geopole').innerHTML = parseFloat(LAMDA).toFixed(1);
					...
					document.getElementById('Bx').innerHTML = parseFloat(Bx).toFixed(2);
					document.getElementById('By').innerHTML = parseFloat(By).toFixed(2);
					document.getElementById('Bz').innerHTML = parseFloat(Bz).toFixed(2);
					document.getElementById('B').innerHTML = parseFloat(B).toFixed(2);
					...
					document.getElementById('X_').innerHTML = parseFloat(X_).toFixed(5);
					document.getElementById('Y_').innerHTML = parseFloat(Y_).toFixed(5);
					document.getElementById('Z_').innerHTML = parseFloat(Z_).toFixed(5);
			}
		}	
		...
		function get_year(){
			...
			var dt1   = parseInt(data.substring(0,2));
			var mon1  = parseInt(data.substring(3,5));
			var yr1   = parseInt(data.substring(6,10));
